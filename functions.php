<?php
/**
 * Noita functions and definitions
 *
...
if ( ! function_exists( 'noita_setup' ) ) :
	 ...
	 */
	function noita_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Noita, use a find and replace
		 * to change 'noita' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'noita', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'noita' ),
			)
		);
 ...
 */
function noita_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'noita' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'noita' ),
